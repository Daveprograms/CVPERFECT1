...
async def get_invoices(
    ...
    """Get invoice/billing history from Stripe"""
    if not current_user.stripe_customer_id:
    ...
    try:
        ...
        invoice_list = [
            {
                "id": inv.id,
                "amount_paid": inv.amount_paid / 100,  # cents → dollars
        ...
        return {"invoices": invoice_list, "has_more": invoices.has_more}
...
async def get_payment_methods(
    ...
    try:
        ...
        return {"payment_methods": method_list}
