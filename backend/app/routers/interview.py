...
async def submit_answer(
    ...
    feedback = await gemini_service.evaluate_interview_answer(
...
async def get_interview_tips(
    ...
    tips = await gemini_service.generate_interview_tips(
        job_role=job_role,
...
async def get_company_prep(
    ...
    prep = await gemini_service.generate_company_prep(
