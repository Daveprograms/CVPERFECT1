...
- ❌ Do NOT use Gemini Pro or upgrade API plans (use `gemini-2.5-flash` or current docs default)
...
class GeminiService:
    def __init__(self, api_key: str):
        ...
        self.model = genai.GenerativeModel('gemini-2.5-flash')  # Existing model
```
...
- ✅ AI analysis uses Gemini 2.0 Flash (server-forced)
